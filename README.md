...
## ChiliPeppr Workspace / TinyG Tablet
...
| Test URL              | https://preview.c9users.io/chilipeppr/workspace-tinygtablet/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/chilipeppr/workspace-tinygtablet/master/auto-generated-workspace.html",
  function() {
    ...
    cprequire(
      ...
      function(myWorkspaceTinyg) {
        ...
        console.log("Workspace / TinyG Tablet just got loaded.", myWorkspaceTinyg);
